...
<%@include file="baseInclude.jsp" %>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">出车记录</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="main.jsp">主页</a> <span class="divider">/</span></li>
            
            <li class="active">车辆出车记录</li>
        </ul>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">车辆出车记录</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form id="tab" name="formAdd" method="post" action="${pageContext.request.contextPath}/saveRuninfo">
   <%--  id=${carInfo.infoId}&lpn=${carInfo.infoLpn}&model=${carInfo.infoModel}&record=${carInfo.infoRecord}&plan=${carInfo.infoPlan}&state=${carInfo.infoCarstate} --%>
        ...
        <label>车辆号码</label>
        <select id="carLpn" name="carInfo.carLpn" class="input-xlarge" >
                            	<option value="">请选择</option>
                            	<c:forEach items="${carInfoList}" var="carInfo">
                           			<option value="${carInfo.infoLpn}" <c:if test="${carInfo.infoLpn==infoLpn}">selected</c:if>>
										${carInfo.infoLpn}
									</option>
                           		</c:forEach>
                            </select>
        ...
        <label>出车时间</label>
        <input type="text" name="runbackinfo.runTime" id="carRunTime" class="input-xlarge">
        <div class="btn-toolbar">
        <input type="submit" class="btn btn-primary" value="确认">
        <a href="main.jsp"  class="btn">取消</a>
<!-- <div class="btn-toolbar">
  ...
  <div class="modal-body">
    ...
    <script type="text/javascript">
        ...
        $(function() {
       	...
       	var t=document.getElementById("carRunTime");  
        d=new Date();
        t.value=d.getFullYear()+"年"+(d.getMonth()+1)+"月"+d.getDate()+"日"+d.getHours()+"点"+d.getMinutes()+"分";
