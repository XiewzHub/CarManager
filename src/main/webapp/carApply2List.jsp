		...
		<div class="container-fluid">
			<div class="row-fluid">
					...
					<table class="table">
						...
						<tbody>
							<c:forEach items="${CarApplyList}" var="carApply">
								<tr
								<c:if test="${carApply.state==CAR_APPLYSTATE1 }">style="background:#9999CC;"</c:if>
									<c:if test="${carApply.state==CAR_APPLYSTATE2 }">style="background:#CCCCFF;"</c:if>>
				...
				<div class="pagination">
					<ul>
						<li><a href="carApply3List?currentPage=1">首页</a></li>
						...
						%>
						<li><a>上一页</a></li>
						<li><a href="carApply3List?currentPage=<%=currentPage + 1%>">下一页</a></li>
						<%
							} else if (currentPage == totalPage) {
						%>
						<li><a href="carApply3List?currentPage=<%=currentPage - 1%>">上一页</a></li>
						<li><a>下一页</a>
						</td> <%
 	} else {
 %>
						...
						%>
						<li><a href="carApply3List?currentPage=<%=totalPage%>">尾页</a></li>
					</ul>
				</div>
