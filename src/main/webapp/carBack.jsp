...
<%@include file="baseInclude.jsp" %>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">进车记录</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="main.jsp">主页</a> <span class="divider">/</span></li>
            <li class="active">车辆进车记录</li>
        </ul>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">车辆进车记录</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form id="tab" name="formAdd" method="post" action="${pageContext.request.contextPath}/saveRuninfo2">
