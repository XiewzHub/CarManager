...
<body class="">
	...
	<div class="content">
		...
		<div class="header">
			...
			<h1 class="page-title">车辆使用申请</h1>
		</div>

		<ul class="breadcrumb">
			<li><a href="main.jsp">主页</a> <span class="divider">/</span></li>
			<li class="active">车辆使用申请</li>
		</ul>
		...
		<div class="container-fluid">
			<div class="row-fluid">
						...
						<tbody>
							<c:forEach items="${carInfoList}" var="carInfo">
								<tr>
									...
									<td><a
										href="${pageContext.request.contextPath}/driverAppplyList?id=${carInfo.infoId}&lpn=${carInfo.infoLpn}&model=${carInfo.infoModel}">申请使用</a>
				...
				<div class="pagination">
					<ul>
						<li><a href="carApplyList?currentPage=1">首页</a></li>
						...
						%>
						<li><a>上一页</a></li>
						<li><a href="carApplyList?currentPage=<%=currentPage + 1%>">下一页</a></li>
						<%
							} else if (currentPage == totalPage) {
						%>
						<li><a href="carApplyList?currentPage=<%=currentPage - 1%>">上一页</a></li>
						<li><a>下一页</a>
							</td> <%
 	} else {
 %>
						...
						%>
						<li><a href="carApplyList?currentPage=<%=totalPage%>">尾页</a></li>
					</ul>
				</div>
			</div>
		</div>
