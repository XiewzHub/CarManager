...
<%@include file="baseInclude.jsp" %>
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">更新驾驶员信息</h1>
        </div>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">更新驾驶员信息</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form id="tab" name="formAdd" method="post" action="${pageContext.request.contextPath}/driverInfoUpdate">
   <%--  ${pageContext.request.contextPath}/driverInfoUpdate.jsp?id=${driverInfo.driverInfoId}&name=${driverInfo.driverName}&age=${driverInfo.driverAge}&type=${driverInfo.driverType}&grade=${driverInfo.driverGrade}&state=${driverInfo.driverState} --%>
        <input type="hidden" value="${param.id}" name="driverInfo.driverInfoId" class="input-xlarge">
        <label>姓名</label>
        <input type="text" value="${param.name}" name="driverInfo.driverName" class="input-xlarge">
        <label>年龄</label>
        <input type="text" value="${param.age}" name="driverInfo.driverAge" class="input-xlarge">
        <label>驾驶证类型</label>
        <input type="text" value="${param.type}" name="driverInfo.driverType" class="input-xlarge">
        <label>等级</label>
        <input type="text" value="${param.grade}" name="driverInfo.driverGrade" class="input-xlarge">
        <label>人员状态</label>
        <input value="${param.state}" name="driverInfo.driverState" class="input-xlarge">
        <div class="btn-toolbar">
        <input type="submit" class="btn btn-primary" value="确认更新">
        <a href="driverInfoList"  class="btn">取消</a>
<!-- <div class="btn-toolbar">
